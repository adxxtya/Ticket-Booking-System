...
<body>
  <div class="text-white w-full">
   <%@ include file="Navbar.jsp" %>
	...
	<img src="./plane.webp" class="brightness-[0.25] -z-10 absolute top-0 left-0 w-full h-full object-cover" alt="">
      <div class="h-[90vh] p-6 flex items-center justify-center">
  <div class="container max-w-screen-lg mx-auto">
    <div>
      <h2 class="font-bold text-4xl text-white">Book Plane Ticket</h2>
      ...
      <div class="bg-white rounded-xl shadow-lg p-4 px-4 md:p-8 mb-6">
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <form action="bookplaneticket" method="post" class="lg:col-span-2">
